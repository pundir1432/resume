...
import { about } from '../../assest/images';
const skillsData = [
...
function Hero() {
  ...
  return (
    <>
      ...
      <div className={`container-fluid   ${scrolled ? 'scrolled' : ''}`}>
        ...
        <div className="container mt-lg-5 ">
          <div className="row">
            <div className="col-12 col-lg-5 d-lg-flex flex-column justify-content-lg-end" data-aos="zoom-out-right">
              <img src={about} className='img-fluid buissness-img ms-auto' alt="" />
            ...
            <div className="col-12 col-lg-7 d-flex justify-content-center align-items-center  " data-aos="zoom-out-left">
              <div className="div-about text-start  w-75">
                ...
                <button className="btn  p-3 px-3 text-white" style={{ backgroundColor: '#151E3D' }}>Download CV</button>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="row">
                  <div className="col-12 col-lg-5">
                    <div className="div d-flex justify-content-center align-items-center" data-aos="flip-left"
                      ...
                      <h2 className='form-heading w-75 mt-lg-5'>Drop me a line I would like to hear from you.</h2>
                    </div>
                  </div>
                  <div className="col-12 col-lg-7"  >
                    <form onSubmit={handleSubmit(onSubmit)}>
                      <h3 className='form-heading' data-aos="zoom-out">Get in Touch</h3>
                      ...
                      <button
                        type="submit"
                        className="btn p-2 px-3 text-white"
                        data-aos="zoom-out"
